...
const Pricing = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-[200vh] bg-black px-6 py-32"
    >
      {/* Title */}
      <div
        ref={titleRef}
        className="text-center text-white text-[130px] font-black tracking-tight mb-16"
      >
        Pricing
      </div>
      ...
      >
        {plans.map((plan, i) => (
          <div
            key={i}
            className="relative group rounded-3xl p-10 text-white shadow-xl flex flex-col justify-between 
              bg-white/10 backdrop-blur-xl border border-white/10 
              transition-all duration-300 transform hover:scale-[1.035] overflow-hidden
              before:content-[''] before:absolute before:inset-0 before:rounded-3xl before:p-[2px]
